...
exports.fetchRandomVector = fetchRandomVector;
/**
...
function fetchRandomVector() {
    return __awaiter(this, arguments, void 0, function (namespace) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(process.env.UPSTASH_VECTOR_REST_URL, "/random/").concat(namespace);
                    headers = {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("Error fetching random vector:", error_1);
                    throw error_1;
