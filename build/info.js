...
function getIndexInfo() {
    return __awaiter(this, void 0, void 0, function () {
        var url, token, response, errorBody, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(url, "/info"), {
                            method: "GET",
                            headers: {
                ...
                case 2:
                    errorBody = _a.sent();
                    throw new Error("HTTP error! status: ".concat(response.status, ", body: ").concat(errorBody));
