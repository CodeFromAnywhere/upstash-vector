 ...
 */
function queryVectors(params, namespace) {
    return __awaiter(this, void 0, void 0, function () {
        var url, token, response, errorBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(process.env.UPSTASH_VECTOR_REST_URL, "/query").concat(namespace ? "/".concat(namespace) : "");
