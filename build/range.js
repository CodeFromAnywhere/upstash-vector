...
exports.rangeVectors = rangeVectors;
/**
 ...
 */
function rangeVectors() {
    return __awaiter(this, arguments, void 0, function (namespace, request) {
        var url, token, response, data;
        if (namespace === void 0) { namespace = ""; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(process.env.UPSTASH_VECTOR_REST_URL, "/range/").concat(namespace);
