...
function listNamespaces() {
    return __awaiter(this, void 0, void 0, function () {
        var url, token, response, errorData, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch("".concat(url, "/list-namespaces"), {
                            method: "GET",
                            headers: {
                ...
                case 5:
                    data = _a.sent();
                    return [2 /*return*/, data.result.namespaces];
                case 6:
                    error_1 = _a.sent();
                    if (error_1 instanceof Error) {
                        throw new Error("Failed to list namespaces: ".concat(error_1.message));
                    }
                    else {
