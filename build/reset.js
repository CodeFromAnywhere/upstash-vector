 ...
 */
function resetNamespace(namespace_1) {
    return __awaiter(this, arguments, void 0, function (namespace, resetAll) {
        var url, response, errorMessage, errorData, _a;
            ...
            switch (_b.label) {
                case 0:
                    if (!process.env.UPSTASH_VECTOR_REST_URL ||
                        ...
                        throw new Error("UPSTASH_VECTOR_REST_URL and UPSTASH_VECTOR_REST_TOKEN must be set in the environment variables.");
                    }
                    url = new URL("".concat(process.env.UPSTASH_VECTOR_REST_URL, "/reset/").concat(namespace || ""));
                    if (resetAll) {
